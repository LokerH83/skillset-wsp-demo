...
const demoCourseRows = [
  ...
  ["Customer Service Training Partner", "Customer Experience Excellence", "Service", "1 day", "Classroom", 1500, "Attendance register", "WSP / ATR"],
  ...
  ["Operations Skills Academy", "Operational Coordination Basics", "Operations", "2 days", "Practical", 3100, "Practical assessment", "WSP / ATR"],
...
const demoEmployees = demoNames.map((employeeName, index) => {
  ...
  return {
    ...
    employeeName,
    idNumber: `DEMO-ID-${String(index + 1).padStart(4, "0")}`,
